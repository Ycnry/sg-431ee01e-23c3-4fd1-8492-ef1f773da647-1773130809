...
import { Star, MessageSquare, Phone, MapPin, Clock, Store } from "lucide-react";
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-start gap-6 mb-6">
                    <Avatar className="h-24 w-24 border-4 border-orange-100 rounded-lg">
                      <AvatarImage src={shop.logo} alt={shop.name} />
                      <AvatarFallback className="bg-orange-100 text-orange-700 text-2xl font-bold rounded-lg">
                        {shop.name.charAt(0)}
                      </AvatarFallback>
                    </Avatar>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mb-3">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-semibold text-lg">{shop.rating.toFixed(1)}</span>
                          <span className="text-muted-foreground">({shop.reviewCount} {t("common.reviews")})</span>
                        </div>
                      </div>
            ...
            <div className="space-y-6">
              ...
              {shop.promoted && (
                <Card className="border-orange-500 border-2">
                  <CardContent className="p-6">
                    <Badge className="mb-3 bg-orange-500">Featured Shop</Badge>
