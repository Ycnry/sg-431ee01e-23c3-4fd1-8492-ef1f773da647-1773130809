...
import { MessageSquare, Phone, Star, MapPin, CheckCircle2, Sparkles } from "lucide-react";
...
export function FundiCard({ fundi, featured }: FundiCardProps) {
  ...
  return (
    <Link href={`/fundi/${fundi.id}`} className="block">
      <Card 
        className={`
      ...
      >
        ...
        <div className="p-4 sm:p-6 relative z-10">
          <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
            <Avatar 
              className={`
                h-12 w-12 sm:h-16 sm:w-16 shrink-0 transition-all duration-300
            ...
            >
              ...
              />
              <AvatarFallback className="bg-blue-100 text-blue-700 font-semibold text-sm sm:text-base dark:bg-blue-900 dark:text-blue-300">
                {fundi.name.charAt(0)}
              </AvatarFallback>
            </Avatar>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mb-1.5 sm:mb-2 truncate transition-transform duration-200 group-hover:-translate-y-0.5">
                {fundi.specialty}
              </p>
